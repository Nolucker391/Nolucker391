...
<p alight="left"> 
  ...
  Работа с фреймворками: Django, Flask<br>
  Контейнеризация в Docker<br>
  Работа с базами данных: PostgreSQL, SQLAlchemy<br>
  Настройка серверов: Nginx<br>
  <br>
  На моем счету уже 6 успешных проектов, с которыми вы можете ознакомиться в закрепе профиля. 👇<br>
  ...
  И это только начало моего пути! Давай познакомимся и вместе создадим что-то вдохновляющее! 🔥🚀
